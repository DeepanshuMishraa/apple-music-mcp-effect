...
const VolumeSchema = Schema.Struct({
    level: Schema.Number.pipe(Schema.int(), Schema.greaterThanOrEqualTo(0), Schema.lessThanOrEqualTo(100), Schema.optional)
});
export const volumeTool = (raw) => effect.gen(function* () {
